 ...
 *
 * Adapted for WellL4 by Carles Cufi (carles.cufi@nordicsemi.no)
 *  - Removed mbedtls_ prefixes
 *  - Reworked coding style
 */
#ifndef SYS_BASE64_H_
#define SYS_BASE64_H_
 ...
 */
sword_t base64_encode(byte_t *dst, size_t dlen, size_t *olen, const byte_t *src,
		  size_t slen);
 ...
 */
sword_t base64_decode(byte_t *dst, size_t dlen, size_t *olen, const byte_t *src, size_t slen);
