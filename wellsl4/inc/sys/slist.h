...
#define SYS_SLIST_FOR_EACH_NODE(__sl, __sn)				\
	GENLIST_FOR_EACH_NODE(slist, __sl, __sn)
...
#define SYS_SLIST_ITERATE_FROM_NODE(__sl, __sn)				\
	GENLIST_ITERATE_FROM_NODE(slist, __sl, __sn)
...
#define SYS_SLIST_FOR_EACH_NODE_SAFE(__sl, __sn, __sns)			\
	GENLIST_FOR_EACH_NODE_SAFE(slist, __sl, __sn, __sns)
 ...
 * @param __n The field name of sys_node_t within the container struct
 */
#define SYS_SLIST_PEEHEAD_CONTAINER(__sl, __cn, __n) \
	GENLIST_PEEHEAD_CONTAINER(slist, __sl, __cn, __n)
 ...
 * @param __n The field name of sys_node_t within the container struct
 */
#define SYS_SLIST_PEETAIL_CONTAINER(__sl, __cn, __n) \
	GENLIST_PEETAIL_CONTAINER(slist, __sl, __cn, __n)
 ...
 * @param __n The field name of sys_node_t within the container struct
 */
#define SYS_SLIST_PEENEXT_CONTAINER(__cn, __n) \
	GENLIST_PEENEXT_CONTAINER(slist, __cn, __n)
...
#define SYS_SLIST_FOR_EACH_CONTAINER(__sl, __cn, __n)			\
	GENLIST_FOR_EACH_CONTAINER(slist, __sl, __cn, __n)
...
#define SYS_SLIST_FOR_EACH_CONTAINER_SAFE(__sl, __cn, __cns, __n)	\
	GENLIST_FOR_EACH_CONTAINER_SAFE(slist, __sl, __cn, __cns, __n)
 ...
 */
static FORCE_INLINE void sys_slist_init(sys_slist_t *list)
{
	list->head = NULL;
	list->tail = NULL;
}
...
static FORCE_INLINE sys_snode_t *snode_next_peek(sys_snode_t *node)
{
	return node->next;
}

static FORCE_INLINE void snode_next_set(sys_snode_t *parent, sys_snode_t *child)
{
	parent->next = child;
}

static FORCE_INLINE void slist_head_set(sys_slist_t *list, sys_snode_t *node)
{
	list->head = node;
}

static FORCE_INLINE void slist_tail_set(sys_slist_t *list, sys_snode_t *node)
{
	list->tail = node;
}
 ...
 */
static FORCE_INLINE sys_snode_t *sys_slist_peek_head(sys_slist_t *list)
{
	return list->head;
}
 ...
 */
static FORCE_INLINE sys_snode_t *sys_slist_peek_tail(sys_slist_t *list)
{
	return list->tail;
}
 ...
 */
static FORCE_INLINE bool sys_slist_is_empty(sys_slist_t *list);

GENLIST_IS_EMPTY(slist)
 ...
 */
static FORCE_INLINE sys_snode_t *sys_slist_peek_next_no_check(sys_snode_t *node);

GENLIST_PEENEXT_NO_CHECK(slist, snode)
 ...
 * @return a pointer on the next node (or NULL if none)
 */
static FORCE_INLINE sys_snode_t *sys_slist_peek_next(sys_snode_t *node);

GENLIST_PEENEXT(slist, snode)
 ...
 */
static FORCE_INLINE void sys_slist_prepend(sys_slist_t *list,
				     sys_snode_t *node);

GENLIST_PREPEND(slist, snode)
 ...
 */
static FORCE_INLINE void sys_slist_append(sys_slist_t *list,
				    sys_snode_t *node);

GENLIST_APPEND(slist, snode)
 ...
 */
static FORCE_INLINE void sys_slist_append_list(sys_slist_t *list,
					 void *head, void *tail);

GENLIST_APPEND_LIST(slist, snode)
 ...
 */
static FORCE_INLINE void sys_slist_merge_slist(sys_slist_t *list,
					 sys_slist_t *list_to_append);

GENLIST_MERGE_LIST(slist, snode)
 ...
 */
static FORCE_INLINE void sys_slist_insert(sys_slist_t *list,
				    sys_snode_t *prev,
				    sys_snode_t *node);

GENLIST_INSERT(slist, snode)
 ...
 */
static FORCE_INLINE sys_snode_t *sys_slist_get_not_empty(sys_slist_t *list);

GENLIST_GET_NOT_EMPTY(slist, snode)
 ...
 */
static FORCE_INLINE sys_snode_t *sys_slist_get(sys_slist_t *list);

GENLIST_GET(slist, snode)
 ...
 */
static FORCE_INLINE void sys_slist_remove(sys_slist_t *list,
				    sys_snode_t *prev_node,
				    sys_snode_t *node);

GENLIST_REMOVE(slist, snode)
 ...
 */
static FORCE_INLINE bool sys_slist_find_and_remove(sys_slist_t *list,
					     sys_snode_t *node);

GENLIST_FIND_AND_REMOVE(slist, snode)
