 ...
 *
 * Doubly-linked list implementation using FORCE_INLINE macros/functions.
 ...
 * @param __n The field name of sys_dnode_t within the container struct
 */
#define SYS_DLIST_PEEHEAD_CONTAINER(__dl, __cn, __n) \
 ...
 * @param __n The field name of sys_dnode_t within the container struct
 */
#define SYS_DLIST_PEENEXT_CONTAINER(__dl, __cn, __n) \
	((__cn != NULL) ? \
...
#define SYS_DLIST_FOR_EACH_CONTAINER(__dl, __cn, __n)			\
	for (__cn = SYS_DLIST_PEEHEAD_CONTAINER(__dl, __cn, __n);     \
	     __cn != NULL;                                              \
	     __cn = SYS_DLIST_PEENEXT_CONTAINER(__dl, __cn, __n))
...
#define SYS_DLIST_FOR_EACH_CONTAINER_SAFE(__dl, __cn, __cns, __n)	\
	for (__cn = SYS_DLIST_PEEHEAD_CONTAINER(__dl, __cn, __n),	\
	     __cns = SYS_DLIST_PEENEXT_CONTAINER(__dl, __cn, __n);    \
...
static FORCE_INLINE void sys_dlist_init(sys_dlist_t *list)
{
...
static FORCE_INLINE void sys_dnode_init(sys_dnode_t *node)
{
	node->next = NULL;
	node->prev = NULL;
}
...
static FORCE_INLINE bool sys_dnode_is_llinked(sys_dlist_t *list, const sys_dnode_t *node)
{
	return node->next == list->tail;
}


static FORCE_INLINE bool sys_dnode_is_linked(const sys_dnode_t *node)
{
...
static FORCE_INLINE bool sys_dlist_is_head(sys_dlist_t *list, sys_dnode_t *node)
{
...
static FORCE_INLINE bool sys_dlist_is_tail(sys_dlist_t *list, sys_dnode_t *node)
{
...
static FORCE_INLINE bool sys_dlist_is_empty(sys_dlist_t *list)
{
...
static FORCE_INLINE bool sys_dlist_has_multiple_nodes(sys_dlist_t *list)
{
...
static FORCE_INLINE sys_dnode_t *sys_dlist_peek_head(sys_dlist_t *list)
{
...
static FORCE_INLINE sys_dnode_t *sys_dlist_peek_head_not_empty(sys_dlist_t *list)
{
	return list->head;
}
...
static FORCE_INLINE sys_dnode_t *sys_dlist_peek_next_no_check(sys_dlist_t *list,
							sys_dnode_t *node)
{
...
static FORCE_INLINE sys_dnode_t *sys_dlist_peek_next(sys_dlist_t *list,
					       sys_dnode_t *node)
{
...
static FORCE_INLINE sys_dnode_t *sys_dlist_peek_prev_no_check(sys_dlist_t *list,
							sys_dnode_t *node)
{
...
static FORCE_INLINE sys_dnode_t *sys_dlist_peek_prev(sys_dlist_t *list,
					       sys_dnode_t *node)
{
...
static FORCE_INLINE sys_dnode_t *sys_dlist_peek_tail(sys_dlist_t *list)
{
...
static FORCE_INLINE void sys_dlist_append(sys_dlist_t *list, sys_dnode_t *node)
{
	node->next = list;
	node->prev = list->tail;
...
static FORCE_INLINE void sys_dlist_prepend(sys_dlist_t *list, sys_dnode_t *node)
{
	node->next = list->head;
	node->prev = list;
 ...
 */
static FORCE_INLINE void sys_dlist_insert(sys_dnode_t *successor, sys_dnode_t *node)
{
 ...
 * function checks if the node is to be inserted _before_ the _current_thread node
 * against which it is checked.
 * This and other sys_dlist_*() functions are not thread safe.
 *
 * @param list the doubly-linked list to operate on
 * @param node the element to insert
 * @param cond a function that determines if the _current_thread node is the correct
 *             insert point
...
static FORCE_INLINE void sys_dlist_insert_at(sys_dlist_t *list, sys_dnode_t *node,
	sword_t (*cond)(sys_dnode_t *node, void *data), void *data)
{
...
static FORCE_INLINE void sys_dlist_remove(sys_dnode_t *node)
{
...
static FORCE_INLINE sys_dnode_t *sys_dlist_get(sys_dlist_t *list)
{
