 ...
 *
 * @note API changed in WellL4 1.11.
 *
 ...
 * @return The computed CRC16 value
 */
static FORCE_INLINE u16_t crc16_ansi(const byte_t *src, size_t len)
{
 ...
 */
byte_t crc8_ccitt(byte_t initial_value, const void *buf, size_t len);
