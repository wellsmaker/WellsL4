...
#ifndef WELLSL4_INCLUDE_DATA_JSON_H_
#define WELLSL4_INCLUDE_DATA_JSON_H_
...
#define ALIGN_SHIFT(type)	(__alignof__(type) == 1 ? 0 : \
...
#define JSON_OBJ_DESCR_PRIM(struct_, field_name_, type_) \
	{ \
		...
		.align_shift = ALIGN_SHIFT(struct_), \
 ...
 * @}
 */
#endif /* WELLSL4_INCLUDE_DATA_JSON_H_ */
