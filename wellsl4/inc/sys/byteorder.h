 ...
 */
static FORCE_INLINE void sys_put_be16(u16_t val, byte_t dst[2])
{
	dst[0] = val >> 8;
	dst[1] = val;
}
 ...
 *  @param dst Destination memory address to store the result.
 */
static FORCE_INLINE void sys_put_be24(u32_t val, byte_t dst[3])
{
	dst[0] = val >> 16;
 ...
 *  @param dst Destination memory address to store the result.
 */
static FORCE_INLINE void sys_put_be32(u32_t val, byte_t dst[4])
{
 ...
 *  @param dst Destination memory address to store the result.
 */
static FORCE_INLINE void sys_put_be48(u64_t val, byte_t dst[6])
{
 ...
 *  @param dst Destination memory address to store the result.
 */
static FORCE_INLINE void sys_put_be64(u64_t val, byte_t dst[8])
{
 ...
 *  @param dst Destination memory address to store the result.
 */
static FORCE_INLINE void sys_put_le16(u16_t val, byte_t dst[2])
{
	dst[0] = val;
	dst[1] = val >> 8;
}
 ...
 *  @param dst Destination memory address to store the result.
 */
static FORCE_INLINE void sys_put_le24(u32_t val, byte_t dst[3])
{
 ...
 *  @param dst Destination memory address to store the result.
 */
static FORCE_INLINE void sys_put_le32(u32_t val, byte_t dst[4])
{
	sys_put_le16(val, dst);
 ...
 *  @param dst Destination memory address to store the result.
 */
static FORCE_INLINE void sys_put_le48(u64_t val, byte_t dst[6])
{
 ...
 *  @param dst Destination memory address to store the result.
 */
static FORCE_INLINE void sys_put_le64(u64_t val, byte_t dst[8])
{
	sys_put_le32(val, dst);
 ...
 *  @return 16-bit integer in host endianness.
 */
static FORCE_INLINE u16_t sys_get_be16(const byte_t src[2])
{
 ...
 *  @return 24-bit integer in host endianness.
 */
static FORCE_INLINE u32_t sys_get_be24(const byte_t src[3])
{
 ...
 *  @return 32-bit integer in host endianness.
 */
static FORCE_INLINE u32_t sys_get_be32(const byte_t src[4])
{
 ...
 *  @return 48-bit integer in host endianness.
 */
static FORCE_INLINE u64_t sys_get_be48(const byte_t src[6])
{
 ...
 */
static FORCE_INLINE u64_t sys_get_be64(const byte_t src[8])
{
 ...
 *  @return 16-bit integer in host endianness.
 */
static FORCE_INLINE u16_t sys_get_le16(const byte_t src[2])
{
 ...
 *  @return 24-bit integer in host endianness.
 */
static FORCE_INLINE u32_t sys_get_le24(const byte_t src[3])
{
 ...
 *  @return 32-bit integer in host endianness.
 */
static FORCE_INLINE u32_t sys_get_le32(const byte_t src[4])
{
 ...
 *  @return 48-bit integer in host endianness.
 */
static FORCE_INLINE u64_t sys_get_le48(const byte_t src[6])
{
 ...
 *  @return 64-bit integer in host endianness.
 */
static FORCE_INLINE u64_t sys_get_le64(const byte_t src[8])
{
 ...
 */
static FORCE_INLINE void sys_memcpy_swap(void *dst, const void *src, size_t length)
{
	byte_t *pdst = (byte_t *)dst;
	const byte_t *psrc = (const byte_t *)src;

	assert_info(((psrc < pdst && (psrc + length) <= pdst) ||
 ...
 */
static FORCE_INLINE void sys_mem_swap(void *buf, size_t length)
{
	size_t i;

	for (i = 0; i < (length/2); i++)
	{
		byte_t tmp = ((byte_t *)buf)[i];

		((byte_t *)buf)[i] = ((byte_t *)buf)[length - 1 - i];
		((byte_t *)buf)[length - 1 - i] = tmp;
	}
}
