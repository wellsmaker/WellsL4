 ...
 */
#ifndef ARCH_ARM64_MMU_ARM_MMU_H_
#define ARCH_ARM64_MMU_ARM_MMU_H_
...
/* More flag from user's perpective are supported using remaining bits
 * of "attrs" field, i.e. attrs[31:3], underlying code will take care
 * of setting PTE fields correctly.
 *
 * _current_thread usage of attrs[31:3] is:
 ...
 */
#define PTE_BLOCDESC_MEMTYPE(x)	(x << 2)
#define PTE_BLOCDESC_NS		(1ULL << 5)
#define PTE_BLOCDESC_AP_RO		(1ULL << 7)
#define PTE_BLOCDESC_AP_RW		(0ULL << 7)
#define PTE_BLOCDESC_NON_SHARE	(0ULL << 8)
#define PTE_BLOCDESC_OUTER_SHARE	(2ULL << 8)
#define PTE_BLOCDESC_INNER_SHARE	(3ULL << 8)
#define PTE_BLOCDESC_AF		(1ULL << 10)
#define PTE_BLOCDESC_NG		(1ULL << 11)
#define PTE_BLOCDESC_PXN		(1ULL << 53)
#define PTE_BLOCDESC_UXN		(1ULL << 54)
...
#define TCR_T0SSHIFT		0U
#define TCR_T0SZ(x)		((64 - (x)) << TCR_T0SSHIFT)
