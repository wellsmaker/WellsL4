 ...
 * but that xcc lacks. Only those that WellL4 requires are provided here.
 */

#ifndef TOOLCHAIN_XCC_MISSING_DEFS_H_
#define TOOLCHAIN_XCC_MISSING_DEFS_H_
