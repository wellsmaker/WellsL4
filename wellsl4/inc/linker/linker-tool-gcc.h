...
#ifndef LINKER_LINKER_TOOL_GCC_H_
#define LINKER_LINKER_TOOL_GCC_H_
 ...
 * GROUP_LININ_LMA to specify the correct output load address.
 */
#ifdef CONFIG_XIP
...
#endif /* LINKER_LINKER_TOOL_GCC_H_ */
