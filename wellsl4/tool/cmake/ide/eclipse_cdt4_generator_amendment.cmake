...
#   ${CMAKE_BINARY_DIR}/wellsl4/include/generated/cmake_intdef.h
...
#   ${CMAKE_BINARY_DIR}/wellsl4/include/generated/autoconf.h to
#   CMAKE_EXTRA_GENERATOR_C_SYSTEM_DEFINED_MACROS.
#
...
set(OUTPUT_FILE ${CMAKE_BINARY_DIR}/wellsl4/include/generated/cmake_intdef.h)
...
file(APPEND ${OUTPUT_FILE} "/*        corresponding to wellsl4_interface           */\n")
get_target_property(_int_comp_def wellsl4_interface INTERFACE_COMPILE_DEFINITIONS)
...
if (${_work_mode} STREQUAL "C and CXX includes, defines in Eclipse with project defines")
  ...
  message("")
  message("   -imacros ${CMAKE_BINARY_DIR}/wellsl4/include/generated/cmake_intdef.h")
...
if ( (${_work_mode} STREQUAL "C and CXX includes, defines in .settings - [EXPERIMENTAL]") OR
  ...
  if (${_work_mode} STREQUAL "C and CXX includes, defines in .settings with project defines - [EXPERIMENTAL]")
    file(APPEND ${OUTPUT_FILE} "\t\t\t<provider class=\"org.eclipse.cdt.managedbuilder.language.settings.providers.GCCBuiltinSpecsDetector\" console=\"false\" id=\"org.eclipse.cdt.managedbuilder.core.GCCBuiltinSpecsDetector\" keep-relative-paths=\"false\" name=\"WellL4 autoconf and SDK Compiler Settings\" parameter=\"${CROSS_COMPILE}\${COMMAND} \${FLAGS} -imacros ${CMAKE_BINARY_DIR}/wellsl4/include/generated/cmake_intdef.h -imacros ${AUTOCONF_H} -E -P -v -dD &quot;\${INPUTS}&quot;\" store-entries-with-project=\"true\">\n")
  else ()
    file(APPEND ${OUTPUT_FILE} "\t\t\t<provider class=\"org.eclipse.cdt.managedbuilder.language.settings.providers.GCCBuiltinSpecsDetector\" console=\"false\" id=\"org.eclipse.cdt.managedbuilder.core.GCCBuiltinSpecsDetector\" keep-relative-paths=\"false\" name=\"WellL4 autoconf and SDK Compiler Settings\" parameter=\"${CROSS_COMPILE}\${COMMAND} \${FLAGS} -E -P -v -dD &quot;\${INPUTS}&quot;\" store-entries-with-project=\"true\">\n")
  endif ()
...
if ( (${_work_mode} STREQUAL "C and CXX includes, defines in .cproject without __cplusplus") OR
  ...
  file(STRINGS ${CMAKE_BINARY_DIR}/wellsl4/include/generated/cmake_intdef.h _int_comp_def)
