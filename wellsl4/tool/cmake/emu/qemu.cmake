...
elseif(QEMU_NET_STACK)
  ...
  if(PCAP)
    ...
    set_ifndef(NET_TOOLS ${WELLSL4_BASE}/../net-tools) # Default if not set
...
if(CONFIG_X86_64)
  ...
  set(QEMU_KERNEL_FILE "${CMAKE_BINARY_DIR}/wellsl4-qemu.elf")
  add_custom_target(qemu_kernel_target
    COMMAND
    ${CMAKE_OBJCOPY}
    -O elf32-i386
    $<TARGET_FILE:${logical_target_for_wellsl4_elf}>
    ${CMAKE_BINARY_DIR}/wellsl4-qemu.elf
...
elseif(NOT DEFINED QEMU_KERNEL_OPTION)
  set(QEMU_KERNEL_OPTION "-kernel;$<TARGET_FILE:${logical_target_for_wellsl4_elf}>")
endif()
