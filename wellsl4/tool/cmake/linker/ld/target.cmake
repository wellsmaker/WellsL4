...
macro(configure_linker_script linker_script_gen linker_pass_define)
  ...
  wellsl4_get_include_directories_for_lang(C current_includes)
...
function(toolchain_ld_force_undefined_symbols)
  foreach(symbol ${ARGN})
    wellsl4_link_libraries(-u${symbol})
  endforeach()
endfunction()
...
include(${WELLSL4_BASE}/tool/cmake/linker/${LINKER}/target_base.cmake)
include(${WELLSL4_BASE}/tool/cmake/linker/${LINKER}/target_baremetal.cmake)
include(${WELLSL4_BASE}/tool/cmake/linker/${LINKER}/target_cpp.cmake)
include(${WELLSL4_BASE}/tool/cmake/linker/${LINKER}/target_relocation.cmake)
include(${WELLSL4_BASE}/tool/cmake/linker/${LINKER}/target_configure.cmake)
