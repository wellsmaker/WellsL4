...
macro(toolchain_ld_relocation)
  set(MEM_RELOCATION_LD   "${PROJECT_BINARY_DIR}/inc/generated/linker_relocate.ld")
  set(MEM_RELOCATION_SRAM_DATA_LD
       "${PROJECT_BINARY_DIR}/inc/generated/linker_sram_data_relocate.ld")
  set(MEM_RELOCATION_SRAM_BSS_LD
       "${PROJECT_BINARY_DIR}/inc/generated/linker_sram_bss_relocate.ld")
  ...
  add_custom_command(
    ...
    COMMAND
    ${PYTHON_EXECUTABLE}
    ${WELLSL4_BASE}/tool/scripts/gen_relocate_app.py
    ...
    DEPENDS app kernel ${WELLSL4_LIBS_PROPERTY}
    )

  add_library(code_relocation_source_lib  STATIC ${MEM_RELOCATION_CODE})
  target_link_libraries(code_relocation_source_lib wellsl4_interface)
endmacro()
