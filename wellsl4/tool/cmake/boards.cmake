...
function(list_archs list_var)
  ...
  FILE(GLOB arch_contents RELATIVE $ENV{WELLSL4_BASE}/src/arch $ENV{WELLSL4_BASE}/src/arch/*)
  set(_arch_list)
  foreach(f ${arch_contents})
    if (IS_DIRECTORY "$ENV{WELLSL4_BASE}/src/arch/${f}")
...
function(list_boards arch list_var)
  ...
  foreach(root ${BOARD_ROOT})
    set(board_arch_dir ${root}/src/plat/${arch})
