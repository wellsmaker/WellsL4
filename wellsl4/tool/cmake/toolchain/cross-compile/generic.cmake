...
#
# It is a legacy mechanism that will in WellL4 translate to
# specififying WELLSL4_TOOLCHAIN_VARIANT to 'cross-compile' with the location
# 'CROSS_COMPILE'.
#
# New users should set the env var 'WELLSL4_TOOLCHAIN_VARIANT' to
# 'cross-compile' and the 'CROSS_COMPILE' env var to the toolchain
# prefix. This interface is consistent with the other non-"WellL4 SDK"
# toolchains.
#
