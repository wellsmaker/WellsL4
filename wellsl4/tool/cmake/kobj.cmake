...
function(gen_kobj gen_dir_out)
  if (PROJECT_BINARY_DIR)
    set(gen_dir ${PROJECT_BINARY_DIR}/inc/generated)
  else ()
    set(gen_dir ${CMAKE_BINARY_DIR}/inc/generated)
  endif ()
  ...
  add_custom_command(
    ...
    COMMAND
    ${PYTHON_EXECUTABLE}
    $ENV{WELLSL4_BASE}/tool/scripts/gen_kobject_list.py
    --kobj-types-output ${KOBJ_TYPES}
    --kobj-otype-output ${KOBJ_OTYPE}
    --kobj-size-output ${KOBJ_SIZE}
    $<$<BOOL:${CMAKE_VERBOSE_MAKEFILE}>:--verbose>
    DEPENDS $ENV{WELLSL4_BASE}/tool/scripts/gen_kobject_list.py
