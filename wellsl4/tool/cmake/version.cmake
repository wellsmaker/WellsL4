...
#   maintainers in ``${WELLSL4_BASE}/VERSION``
#
...
include(${WELLSL4_BASE}/tool/cmake/hex.cmake)
file(READ ${WELLSL4_BASE}/VERSION ver)
...
message("WellL4 version: ${PROJECT_VERSION}")
...
set(WELLSL4_VERSION_CODE ${KERNEL_VERSION_NUMBER_INT})
