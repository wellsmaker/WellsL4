...
file(MAKE_DIRECTORY ${PROJECT_BINARY_DIR}/kconfig/inc/generated)
file(MAKE_DIRECTORY ${PROJECT_BINARY_DIR}/kconfig/inc/config)
...
elseif(EXISTS   ${APPLICATION_SOURCE_DIR}/Kconfig)
  ...
  set(KCONFIG_ROOT ${WELLSL4_BASE}/Kconfig)
endif()
...
set(EXTRA_KCONFIG_TARGET_COMMAND_FOR_menuconfig
  ${WELLSL4_BASE}/tool/scripts/kconfig/menuconfig.py
  )

set(EXTRA_KCONFIG_TARGET_COMMAND_FOR_guiconfig
  ${WELLSL4_BASE}/tool/scripts/kconfig/guiconfig.py
  )

set(EXTRA_KCONFIG_TARGET_COMMAND_FOR_hardenconfig
  ${WELLSL4_BASE}/tool/scripts/kconfig/hardenconfig.py
  )
...
foreach(kconfig_target
  ...
  add_custom_target(
    ...
    srctree=${WELLSL4_BASE}
    KERNELVERSION=${KERNELVERSION}
    WELLSL4_BASE=${WELLSL4_BASE}
...
if(EXTRA_KCONFIG_OPTIONS)
  set(EXTRA_KCONFIG_OPTIONS_FILE ${PROJECT_BINARY_DIR}/config/extra_kconfig_options.conf)
  file(WRITE
...
execute_process(
  COMMAND
  ${PYTHON_EXECUTABLE}
  ${WELLSL4_BASE}/tool/scripts/kconfig/kconfig.py
  ${KCONFIG_ROOT}
  ${DOTCONFIG}
  ${AUTOCONF_H}
