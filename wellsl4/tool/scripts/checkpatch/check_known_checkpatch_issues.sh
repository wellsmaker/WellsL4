...
do_checkpatch_bin=${WELLSL4_BASE}/scripts/checkpatch/do_checkpatch.sh
timestamp_bin=${WELLSL4_BASE}/scripts/checkpatch/timestamp
...
known_checkpatch_issues=${WELLSL4_BASE}/scripts/known_checkpatch_issues
