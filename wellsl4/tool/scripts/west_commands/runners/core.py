...
"""WellL4 binary runner core interfaces

This provides the core WellsL4BinaryRunner class meant for public use,
...
class BuildConfiguration:
    ...
    def _init(self):
        self._parse(os.path.join(self.build_dir, 'wellsl4', '.config'))
...
class WellsL4BinaryRunner(abc.ABC):
    '''Abstract superclass for binary runners (flashers, debuggers).

    **Note**: these APIs are still evolving, and will change!

    With some exceptions, boards supported by WellL4 must provide
    generic means to be flashed (have a WellL4 firmware binary
    ...
    are compatible with them to the WellL4 build system, along with
    ...
    1. Define a WellsL4BinaryRunner subclass, and implement its
    ...
    3. Give your runner's name to the WellL4 build system in your
       board's board.cmake.
    ...
    For command-line invocation from the WellL4 build system, runners
    ...
    def get_runners():
        ...
        return WellsL4BinaryRunner.__subclasses__()
