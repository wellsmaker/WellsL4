...
from build_helpers import is_wellsl4_build, find_build_dir, \
    FIND_BUILD_DIR_DESCRIPTION

from wellsl4_ext_common import Forceable
...
BUILD_DESCRIPTION = '''\
Convenience wrapper for building WellL4 applications.
...
class Build(Forceable):
    ...
    def do_run(self, args, remainder):
        ...
        if is_wellsl4_build(self.build_dir):
            if pristine == 'always':
                self._run_pristine()
                self.run_cmake = True
            else:
    ...
    def _sanity_check_source_dir(self):
        ...
        self.check_force(
            not is_wellsl4_build(self.source_dir),
    ...
    def _run_pristine(self):
        ...
        if not is_wellsl4_build(self.build_dir):
    ...
    def _append_verbose_args(self, extra_args, add_dashes):
        ...
        # 3.14. When WellL4's minimum version is at least that, we can
