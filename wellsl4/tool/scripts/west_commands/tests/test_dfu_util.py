...
@patch('runners.core.WellsL4BinaryRunner.require', side_effect=require_patch)
@patch('runners.core.WellsL4BinaryRunner.check_call')
...
@patch('runners.dfu.DfuUtilBinaryRunner.find_device',
       side_effect=find_device_patch)
@patch('runners.core.WellsL4BinaryRunner.get_flash_address',
