...
#ifndef WELLSL4_INCLUDE_DT_BINDINGS_CLOCK_IMX_CCM_H_
#define WELLSL4_INCLUDE_DT_BINDINGS_CLOCK_IMX_CCM_H_
...
#endif /* WELLSL4_INCLUDE_DT_BINDINGS_CLOCK_IMX_CCM_H_ */
