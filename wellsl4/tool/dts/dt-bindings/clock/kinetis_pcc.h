...
#ifndef WELLSL4_INCLUDE_DT_BINDINGS_CLOCK_KINETIS_PCC_H_
#define WELLSL4_INCLUDE_DT_BINDINGS_CLOCK_KINETIS_PCC_H_
...
#endif /* WELLSL4_INCLUDE_DT_BINDINGS_CLOCK_KINETIS_PCC_H_ */
